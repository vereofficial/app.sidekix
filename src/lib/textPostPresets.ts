...
export const TEXT_POST_PRESETS: readonly TextPostPreset[] = [
  {
    id: 0,
    label: 'Moss',
    /** Default text-only look — brand greens (was flat gray “VOID”). */
    light: ['#f0f6ea', '#ddeed0', '#c8dfc0'],
    ...
    accentBorderLight: 'rgba(90,122,0,0.28)',
    accentBorderDark: 'rgba(212,255,63,0.32)',
    textLight: '#142010',
    textDark: '#e8f5dc',
  },
  {
    id: 1,
    label: 'ACID',
    light: ['#e6f2dc', '#d0e8c4', '#b5d5a8'],
    dark: ['#020803', '#081408', '#051006'],
    glowDark: {
      colors: ['rgba(212,255,63,0)', 'rgba(120,220,90,0.42)'],
      start: { x: 0, y: 1 },
      end: { x: 0.85, y: 0.15 },
  ...
  },
  {
    ...
    accentBorderLight: 'rgba(100,60,160,0.26)',
    accentBorderDark: 'rgba(200,160,255,0.32)',
    textLight: '#1a1024',
    textDark: '#f2e8ff',
  },
  {
    ...
    accentBorderLight: 'rgba(180,120,40,0.28)',
    accentBorderDark: 'rgba(255,200,100,0.34)',
    textLight: '#2a1810',
    textDark: '#fff6e8',
  },
  {
    ...
    accentBorderLight: 'rgba(80,100,120,0.26)',
    accentBorderDark: 'rgba(180,200,220,0.28)',
    textLight: '#101418',
    textDark: '#e8eef4',
  },
] as const;
